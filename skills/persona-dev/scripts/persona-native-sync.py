...
# Values under a credential-like key that cannot hold a secret: an env reference, a flag, a number, or a path.
NOT_SECRET = re.compile(r"\$\{[A-Za-z_][A-Za-z0-9_]*\}|true|false|\d+|[/~]\S*", re.I)
